        ...
        <div className="mx-auto max-w-3xl">
          ...
          >
            <div className="space-y-6">
              <h2 className="text-2xl font-semibold tracking-tight text-white">Our Story</h2>
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-semibold tracking-tight text-white">Artist Management</h2>
              <p className="text-base leading-8 text-gray-300">
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-semibold tracking-tight text-white">Events & Community</h2>
              <p className="text-base leading-8 text-gray-300">
            ...
            <div className="pt-8 text-center">
              <h2 className="text-2xl font-semibold tracking-tight text-white mb-4">Get in Touch</h2>
              <p className="text-base text-gray-300 mb-6">
                Have a question or want to collaborate? We'd love to hear from you.
              </p>
              <a
                href="mailto:oecus.info@gmail.com"
                className="inline-flex items-center justify-center rounded-md bg-white/10 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-white/20 transition-all duration-200"
              >
                Contact Us
              </a>
            </div>
